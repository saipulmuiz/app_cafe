...
class Admin_model extends CI_model{
   ...
   // id_menu	nama_menu	kategori	harga	foto	deskripsi	created_at	update_At
    ...
    public function getTopMenu(){
        return $this->db->query("SELECT * FROM menu ORDER BY id_menu DESC LIMIT 4")->result();
    }

    public function getTopTransaksi(){
        return $this->db->query("SELECT * FROM transaksi_head WHERE status_pemesanan='Belum Dibayar' ORDER BY id_transaksi DESC LIMIT 4")->result();
    }
